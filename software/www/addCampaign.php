...
<body class="theme-blue">
 ...
 where (role_prev_id='2' or role_prev_id='8') and orgunit_id='$orgunit_id'";
                                            ...
                                            <meta http-equiv='refresh' content='3;url=addCampaign.php'>";
                                                ...
                                                //Prepare our INSERT statement.
                                                    ...
                                                    $sql = "INSERT INTO campaign ( CampName, Camp_category, CampType, CampFor, CampDate, ou_id, Camp_Status,  Camp_Created_Date, rtemid, mailserverid, productid ,format_type,embargo_type, campaign_embargo_days ) 
                                                        VALUES (:CampName, :Camp_category, :CampType, :CampFor, :CampDate, :ou_id, :Camp_Status, Now(), :rtemid, :mailserverid, :productid, :format_type, :embargo_type, :campaign_embargo_days )";
                                                    ...
                                                    if ($result > 0) {
                                                        ...
                                                        if (isset($_POST["subscription_draft"]) && !empty(trim($_POST["subscription_draft"])) && isset($_POST["Camp_sub"]) && !empty(trim($_POST["Camp_sub"]))) {
                                                            //$CampID = $_POST['CampID'];
                    ...
                    <a href='addDraft.php?CampID=" . $CampID . "'>
...
-------------------------------------------- -->
                                                <div class="input-group input-group-sm mb-3">
                                                    ...
                                                    <select class="custom-select" id="CampType" name="CampType" required>
                                                        <!-- <option value="Other" selected> Other</option> -->
                                                        <option value="" disabled selected>Please Select Campaign Type</option>
                                                        <?php $ctype_query = "SELECT * from Campaign_type inner join tbl_orgunit_ctype 
                                                ...
                                                <?php if (isset($_SESSION['ET'])) {
                                                    if (($_SESSION['ET'] == "YES") and  (isset($_SESSION['settings_type'])) and
                                                        ($_SESSION['settings_type'] == "sys-defined")
                                                    ) { ?>
                                                ...
                                                <br> <button type="submit" name="addCampaign" class="btn btn-primary"><i class="fa fa-plus"></i> Add Campaign</button>
                                                <?php
                                                if (empty($already)) {
                                                    echo $already = "";
                                                } else
