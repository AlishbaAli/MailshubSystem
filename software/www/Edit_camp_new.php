...
<body class="theme-blue">
 ...
 where (role_prev_id='2' or role_prev_id='8') and orgunit_id='$orgunit_id'";
                                        ...
                                        $con = "SELECT *, ou.user_id as AdminID FROM campaign c, tbl_orgunit_user ou where c.ou_id=ou.ou_id and  CampID ='$CampID' ";
...
";
                                                ...
                                                <div class="input-group input-group-sm mb-3">
                                                    ...
                                                    <select class="custom-select" id="CampType" name="CampType" required>
                                                        ...
                                                        <?php
                                                        $cctn =  $valc['CampType'];
                                                        $ctype_query = "SELECT * from Campaign_type where ctype_status='Active'";
                                                        $ctype = $conn->prepare($ctype_query);
                                                        $ctype->execute();
                                                        echo ' <option selected value="' . $cctn . '">' . $cctn . '</option>';
