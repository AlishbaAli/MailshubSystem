                                            ...
                                            <div class="demo-masked-input">
                                               ...
                                               <div  id="campaign_exist_alert" style="display:none" class="alert alert-danger alert-dismissible fade show" role="alert">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="ctype_product" class="form-control" required>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="ctype_questionare" class="form-control" required>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="ctype_TOC" class="form-control" required>

                                                            <option value="None"> None</option>
                                                            <option value="Scoupus">Scoupus</option>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row["ctype_product"] . " "; ?></td>
                                                            <td><?php echo $row["ctype_questionare"] . " "; ?></td>
                                                            <td><?php echo $row["ctype_article_list"] . " "; ?></td>
                                                            <td><?php echo $row["ctype_TOC"] . " "; ?></td>
