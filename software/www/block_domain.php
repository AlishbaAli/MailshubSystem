						...
						<div class="col-lg-12">
							<div class="card">
								<div class="header">
									...
									<a class="btn btn-primary btn-lg waves-effect waves-light" href="block_domain_form.php"> <i class="icon-ban"></i> Block Domain </a> <br><br>
								</div>
        ...
        if ($_SESSION['r_level'] == 0)  { ?>
   			...
   			<!--------------------
                      ...
                      -------------------->
										...
										FROM `blocked_domains`";
													...
													if ($stmt->rowCount() > 0) {
														...
														foreach ($result as $row) {	?>
															...
															<td>
																<a href="block_domain_edit.php?id=<?php echo $row["blocked_domain_id"]; ?>"> <button type="button" class="btn btn-info" title="Edit"><i class="fa fa-edit"></i></button></a>
									...
									<?php   } } // r_level session restrivtion close?>		
								</div>
