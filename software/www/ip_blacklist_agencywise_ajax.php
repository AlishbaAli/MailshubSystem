...
<div class="table-responsive">                    
                                    <table id="display2" class="table  center-aligned-table table-bordered table-hover dataTable table-custom ">
...
inner join mailservers on mailservers.mailserverid = ipdetails.mailserverid 
 ...
 WHERE ( whitelist_date is null and blacklist_duration is null)";
 ...
 $stmt->execute();
    ...
    inner join mailservers on mailservers.mailserverid = ipdetails.mailserverid 
                                                ...
                                                left join ip_pool on ip_pool.ip_pool_id = ip_addresses.ip_pool_id
                                                left join service_providers on service_providers.sp_id=ip_pool.sp_id
     RIGHT JOIN tbl_ipblacklist_log ON ipdetails.ipdetailid= tbl_ipblacklist_log.ipdetailid WHERE dnsbl_id=:service_provider and 
     whitelist_date is null and blacklist_duration is null";
 $stmt = $conn->prepare($sql);
