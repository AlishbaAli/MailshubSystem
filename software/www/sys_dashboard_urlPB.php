...
FROM `permanently_blocked_url` WHERE 1";
$MS=$conn->prepare($MS);
$MS->execute();
$ms=$MS->fetch();
                    ...
                    <div class="col-sm-4">
                        <div class="card" style="border-color:black;">
                            <div class="header"  style="cursor: pointer;"  data-toggle="modal" 
                                            data-target="#urlpb1">
                                <h2 class="text-center">Permanently Blocked Urls 
                                </h2>
...
$query="SELECT *,date(system_date)as sd FROM permanently_blocked_url";
$query=$conn->prepare($query);
$query->execute();
$rows=$query->fetchAll();

?>
                    <div class="modal fade"   id="urlpb1"  
                    ...
                    <div class="modal fade"   id="inactiveurlpb1"  
                    ...
                    <div class="modal fade"   id="activeurlpb1"  
                                                    role="dialog" aria-labelledby="exampleModalCenterTitle" style="max-width: '100%';" >
                                                                    <div class="modal-dialog modal-dialog-centered " 
                                                                    style="max-width: '100%';min-width: 50%;" role="document">
                                                                        <div class="modal-content">                                                                           
