                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="Edit_camp_new.php?CampID=<?php echo $row["CampID"]; ?>"> <button type="button" class="btn btn-warning" title="Edit">Edit Campaign
                                                                ...
                                                                <?php if ($result_act['add_draft_activity'] == 1 && $result_act['verification_activity'] != 1) { ?>
                                                                    ...
                                                                    <button id="<?php echo $row['CampID']; ?>" value="<?php echo $message_app ?>" class="btn btn-info" data-toggle="modal" data-target="#exampleModalCenter<?php echo $row['CampID']; ?>"> View Draft</button>
                                                                    ...
                                                                    <a target="_blank" href='deleteDraft.php?CampID=<?php echo $row["CampID"]; ?>'><button type='button' data-type="confirm" onclick='return deletedraft();' class='btn btn-secondary'>Discard Draft</button></a>
                                                                ...
                                                                <!-- <?php if ($result_act['add_draft_activity'] != 1) { ?>
                                                                    ...
                                                                    <a href='verifyAlert.php?CampID=<?php echo $row["CampID"]; ?>'><button type='button' data-type="confirm" disabled onclick='return sendalert();' class='btn btn-success'>Verify Alert</button></a>
<?php } ?> -->
                                                            </td>
                                ...
                                <br id="pv"><br> <br>
                                    ...
                                    <div class="table-responsive">
                                        <table class=" table center-aligned-table table-bordered table-hover js-basic-example dataTable table-custom">
                                            ...
                                            <tbody>
                                                <?php $sql = "SELECT campaign.CampID, `CampName`, `CampDate`, `user_id`, `Camp_Status`, `rtemid` ,draft.subscription_draft,draft_subject
                                    FROM `campaign`  left join tbl_orgunit_user on tbl_orgunit_user.ou_id=campaign.ou_id left join draft on draft.CampID=campaign.CampID
                                    ...
                                    and ou_status='Active'";
                                            ...
                                            left join tbl_orgunit_user on tbl_orgunit_user.ou_id=campaign.ou_id  WHERE campaign.CampID = :CampID ');
