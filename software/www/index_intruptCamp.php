                                         ...
                                         <br><h4><b>Campaigns Interrupted (Mail Server Unavailable)</b></h4>
                                        ...
                                        <table class=" table center-aligned-table table-bordered table-hover js-basic-example dataTable table-custom">
                                                ...
                                                Where Camp_Status = 'Interuptted (Mail Server Unavailable)' and crtem_status != 'In Active' and ou_status='Active'";
