...
$MS="SELECT  Count(`blocked_url_org`.`url`) as urlb,
Count(Case when blocked_url_org.status='In Active' then blocked_url_org.`url` end ) as Inactiveorg,
count(Case when blocked_url_org.status='Active' then blocked_url_org.`url` end ) as Activeorg
FROM `blocked_url_org`inner join blocked_url on blocked_url_org.blocked_url_id=blocked_url.blocked_url_id";
...
$query="SELECT *,blocked_url_org.status as status,date(blocked_url_org.system_date)as sd 
 FROM `blocked_url_org`inner join blocked_url on blocked_url_org.blocked_url_id=blocked_url.blocked_url_id";
