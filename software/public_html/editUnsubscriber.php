    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="container-fluid">
                ...
                $id = $_GET['UnsubscribeID'];

                $stmt = $conn->prepare("SELECT * FROM unsubscriber WHERE UnsubscribeID= $id");
                $stmt->bindValue(':UnsubscribeID', $id);
                $stmt->execute();
                $row = $stmt->fetch();
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="demo-masked-input">
                                    <form class="custom-validation" action="editUnsubcriber_db.php" method="post">
                                        ...
                                        <div class="form-group ">
                                            <label>Email *</label>
                                            <input type="text" name="UnsubscriberEmail" value="<?php echo $row['UnsubscriberEmail']; ?>" class="form-control email" required>
