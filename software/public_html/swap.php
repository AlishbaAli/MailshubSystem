...
$CampID= $_GET['CID'];
//get user_id
$stmtu= $conn->prepare("SELECT user_id, Camp_Status FROM campaign INNER JOIN tbl_orgunit_user
ON  campaign.ou_id= tbl_orgunit_user.ou_id WHERE CampID=:CampID");
