                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <button type="button" class="btn  btn-simple  btn-filter2" style="background-color:#344453; color: white;" data-target="Unassigned">Unassigned Users</button>
                                ...
                                <br>
                                         ...
                                         LEFT JOIN tbl_user_role_prev AS r ON u.AdminId = r.user_id GROUP BY u.username";
                                            ...
                                            <table class=" table center-aligned-table table-bordered table-hover js-basic-example dataTable table-custom">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = $stmt->fetch()) {
                                                        $stmtou = $conn->prepare("SELECT ou_status FROM  tbl_orgunit_user WHERE user_id =:user_id AND 
                                                        ou_status!='Left Organization'");
                                                        $stmtou->bindValue(':user_id', $row["user_id"]);
                                                        $stmtou->execute();
                                                        $rowou = $stmtou->fetch();  
                                            ...
                                            <button type="submit" name="submit" value="Submit" class="btn btn-primary">Send</button>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($row["role"] != "") {
                                                                ...
                                                                foreach ($role_ids_arr as $rid) {
                                                                    ...
                                                                    $stmtr = $conn->prepare("SELECT role_prev_title,restriction_level FROM tbl_role_privilege WHERE role_prev_id =$rid");
                                                                    $stmtr->execute();
                                                                    $rowr = $stmtr->fetch();
                                                        ...
                                                        <td>
                                                            ...
                                                            $stmtd = $conn->prepare("SELECT orgunit_id FROM  tbl_orgunit_user WHERE user_id =:user_id AND ou_status='Active'");
                                                        ...
                                                        <td>
                                                        <?php if($row["status"]=="org_terminated" || $row["status"]=="Terminated" || $row['status']=='In Active'){?>
                                        ...
                                        <?php    }
                                                    ...
                                                    echo $row["status"]; }?>   
                                                        ...
                                                        <?php 
                                                            ...
                                                            if($rowou['ou_status']=="Org Terminated" || $rowou['ou_status']=="User Terminated" || $rowou['ou_status']=="Left Organization"){?>
                                                
                                                                <span class="badge badge-danger"><?php echo $rowou['ou_status']; ?></span>
                                                                <?php } 
                                                            else if($rowou['ou_status']=="Active"){ ?>
                  
                                                                <span class="badge badge-success"><?php echo $rowou['ou_status']; ?></span>
                
                                                        <?php    }
                                                                
                                                                else {
                                                                    echo $rowou['ou_status']; }?> 
                                                        ...
                                                        <td>
                                                            <?php if($row["status"]=="org_terminated" || $row["status"]=="Terminated" || $rowou['ou_status']=='Left Organization'){
                                                            ...
                                                            <?php if ($row["role"] == "" && $id == "") { ?>
                                                                <a class="btn btn-warning btn-sm" href="user_edit.php?id=<?php echo $row["user_id"]; ?>&org_id=<?php echo $id; ?>">Make Super Admin</a> <br> <br>
                                                                <a class="btn btn-primary btn-sm" href="edit_user_org.php?id=<?php echo $row["user_id"]; ?>">Assign Organization</a> <br> <br>
                                                            <?php } ?>
                                                            ...
                                                            if ($res_level == "0") { ?>
                                                                ...
                                                                <a class="btn btn-danger btn-sm" href="user_edit.php?id=<?php echo $row["user_id"]; ?>&org_id=<?php echo $id; ?>">Revoke SA</a>  <br> <br>
                                                            <?php }
                                                            if ($row["role"] == "" && $id != "") {
                                                            ?>
                                                                <a class="btn btn-primary btn-sm" href="user_edit.php?id=<?php echo $row["user_id"]; ?>&org_id=<?php echo $id; ?>">Add Role</a>  <br> <br>
                                                                <a class="btn btn-danger btn-sm" href="edit_user_org.php?id=<?php echo $row["user_id"]; ?>">Remove/Change Organization</a> <br> <br>
                                                            <?php }
                                                            if ($row["role"] != "" && $id != "") {
                                                            ?>
                                                                <a class="btn btn-warning btn-sm" href="user_edit.php?id=<?php echo $row["user_id"]; ?>&org_id=<?php echo $id; ?>">Modify Role</a>  <br> <br>
                                                            <?php } ?>
                                                            <a class="btn btn-warning btn-sm" href="user_status.php?id=<?php echo $row["user_id"]; ?>">Modify Status</a> <br> <br>
                                    ...
                                    <!---unassigned and left org users STATRTS--->
                                         
                                    <!-- <h2>Add Users and Roles</h2> -->
                                    <section id="Unassigned" data-status="Unassigned">
                                            ...
                                            <table class=" table center-aligned-table table-bordered table-hover js-basic-example dataTable table-custom">
                                                ...
                                                if ($row["role"] != "") {
                                                    ...
                                                    if ($flag == 1) {
                                                        ...
                                                        $stmtou = $conn->prepare("SELECT ou_status FROM  tbl_orgunit_user WHERE user_id =:user_id");
                                                        $stmtou->bindValue(':user_id', $row["user_id"]);
                                                        $stmtou->execute();
                                                        $rowou = $stmtou->fetch();
                                                    
                                                      
                                                        if($stmtou->rowCount()>0 AND $rowou['ou_status']!='Left Organization')
                                                        {
                                                            continue;
                                                        }
                                                    ?>
                                        ...
                                        <?php    }
                                                    ...
                                                    echo $row["status"]; }?>   
                                                        ...
                                                        <td>
                                                           ...
                                                           $stmtou= $conn->prepare("SELECT * FROM `tbl_orgunit_user` WHERE `user_id`=:user_id AND `ou_status`='Active'");
                                                           $stmtou->bindValue(':user_id',$row["user_id"]);
                                                           $stmtou->execute();
                                                          ...
                                                          if (($row["role"] == "" && $id == "") ||  $stmtou->rowCount()<1) { ?>
                                                                <a class="btn btn-warning btn-sm" href="user_edit.php?id=<?php echo $row["user_id"]; ?>&org_id=<?php echo $id; ?>">Make Super Admin</a> <br> <br>
                                                                <a class="btn btn-primary btn-sm" href="edit_user_org.php?id=<?php echo $row["user_id"]; ?>">Assign Organization</a> <br> <br>
                                                            <?php } ?>
