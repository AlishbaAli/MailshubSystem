    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="container-fluid">
                ...
                $stmt = $conn->prepare("SELECT * FROM blocked_url WHERE blocked_url_id= $id");
                $stmt->bindValue(':blocked_url_id', $id);
                $stmt->execute();
                $row = $stmt->fetch();
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div  id="not_allowed_alert" style="display:none" class="alert alert-danger alert-dismissible fade show" role="alert">
                                    ...
                                    <form class="custom-validation" action="block_url_edit_db.php" method="post">
