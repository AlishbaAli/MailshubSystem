...
//---------------------------------
///------------------------------------    
                                        echo " <div class='col-12'> <h3>Verify Alert For <span style='color:#1740A5;'>" . $row["CampName"] . "</span> Campaign </h3> </div> ";
                                          } else {
    ...
    $last_name='Lastname';
                                ...
                                $sql_get = "SELECT
                                   ...
                                   -- d.subscription_draft
                                     cal.camp_alert
                                 FROM
                                      campaign c, camp_alerts cal
                                 WHERE
                                  cal.CampID = c.CampID AND  cal.alert_iteration=(SELECT max(alert_iteration) from camp_alerts cal where  cal.CampID = :CampID )
                                   and  c.CampID = :CampID";
...
$draftalert=$cmp_draft_new;
                             ...
                             // cron for verify alert will send mail to verification manager not this code ....
                                        ...
                                        if ($status["Camp_Status"] == "Pending Verification Alert") {
                                            ...
                                            $pendingMsg     =     "<div id=alertmsg class='col-12' > <div id=first_alertmsg class='alert alert-info alert-dismissible' role='alert'>
                                       ...
                                       Status will be changed with in 5 minutes
                                            ...
                                            echo $pendingMsg;
                                   echo '<div id=alertmsg class="col-12" > <a class="col-12" href="index.php">
                                    <button id="OK" class="btn btn-primary float float-right" >OK</button> </a><br><br> </div>';
