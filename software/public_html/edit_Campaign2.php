...
if (isset($_SESSION['ECAMP'])) {
    if ($_SESSION['ECAMP'] == "NO") {
                            ...
                            <div class="card">
                                ...
                                <div class="header">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <!-- --------------------------------------------------------------------------------- -->
                                            <h3>Edit Draft Here</h3>
                                            <?php  $CampID=$_GET['CampID'];
                                            
                                            // Component id of article list is '2'
                                            $checkk=" SELECT * FROM components_for_campaign_type cct, campaign c WHERE cct.ctype_id=c.ctype_id 
                                            and c.CampID = :CampID and component_id='2' and cct.requirement_status != 'Not Required' ";
                                            $checkk=$conn->prepare($checkk);
                                            $checkk->bindParam(':CampID', $CampID);
                                            $checkk->execute();
                                            $checkk->fetch();
                                            ...
                                            <button  data-toggle="modal" data-target="#art_list" type="button" class="btn btn-warning" title="Article_List">Update Articles</button>

                                                                     <div class="modal fade" id="art_list" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                                        <div class="modal-dialog modal-dialog-centered" style="max-width: '100%';min-width: 80%;" role="document">
                                                                            <div class="modal-content" style="overflow:scroll;">

                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title" id="exampleModalCenterTitle"> Article List </h5>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <div id=""> <?php include "article_list_modal.php"; ?></div>
                                            ...
                                            <?php } // if loop for checking article list component closed ?>
                                    ...
                                    try {
                                        if (isset($_POST['editCampaign'])) {
                                            ...
                                            $ou_id = !empty($_POST['ou_id']) ? trim($_POST['ou_id']) : null;
...
$Header_Banner=$Footer_Banner="";
                                            if (isset($_FILES["Header_Banner"]["name"])) {
                                            $Header_Banner = $_FILES["Header_Banner"]["name"];
                                            }
                                            if (isset($_FILES["Footer_Banner"]["name"])) {
                                            $Footer_Banner = $_FILES["Footer_Banner"]["name"];
                                            }
                                            $header_banner_old = !empty($_POST['header_banner_old']) ? trim($_POST['header_banner_old']) : null;
                                            $footer_banner_old = !empty($_POST['footer_banner_old']) ? trim($_POST['footer_banner_old']) : null;
                                            ...
                                            // else {
                                               ...
                                               // $stmt->bindValue(':Camp_Status', $Camp_Status);
                                                ...
                                                if ($result > 0) {
                                                    ...
                                                    $PK = $CampID;
                                                    $date = date('Ymd');
if (!empty($Header_Banner) || $Header_Banner!= null)
{
    ...
    $file_name_hb = $header_banner_old;
}
if (!empty($Header_Banner) || $Header_Banner!= null)
{
    ...
    $file_name_fb = $footer_banner_old;
}
                                                    ...
                                                    $Camp_Status = "Inactive Edit";
                                                    $sql = "INSERT INTO Campaign_flow (CampID, Camp_Status) 
                                                        VALUES (:CampID, :Camp_Status)";

                                                    $stmt = $conn->prepare($sql);

                                                    $stmt->bindParam(':CampID', $PK);
                                                    $stmt->bindParam(':Camp_Status', $Camp_Status);
                                                    ...
                                                    // if (isset($_POST['institutions']) && !empty($_POST['institutions']))
                                                    // {
                                                    // $institutions = $_POST['institutions'];
                                                
                                                
                                                  
                                                    //     $ins_stmt = $conn->prepare("INSERT INTO campaign_institutes(ou_inst_id,CampID, system_date) 
                                                    //     VALUES (:ou_inst_id, :CampID, NOW())");
                                                    //     $ins_stmt->bindValue(':CampID', $CampID);
                                                    //     $ins_stmt->bindValue(':ou_inst_id', $institutions);
                                                    //     $ins_stmt->execute();
                                                    // }
                                                    //-----------------------------[Article List] ----------------------------------------------------------//
                            ...
                            //                             }
                                                        ...
                                                        if ($flag == 0) {
                                                            ...
                                                            $draftexist="SELECT * FROM draft where CampID = '$CampID' ";
                                                            $draftexist=$conn->prepare($draftexist);
                                                            $draftexist->execute();

                                                            if ($draftexist->rowCount()>0){

                                                                $insert_draft_query = "UPDATE draft SET 
                                                            
                                                                subscription_draft=  '" . htmlentities(addslashes($subscription_draft)) . "',
                                                                draft_subject =  '" . htmlentities(addslashes($Camp_sub)) . "',
                                                                CampID =  '" . $CampID . "', 
                                                            ...
                                                            $result1 = $stmtt->execute();
                                                                ...
                                                                $insert_draft_query = "INSERT INTO draft (subscription_draft, draft_subject, CampID, templete_created_date)
                                                               VALUES 
                                                            (
                                ...
                                <div class="body">
                                    <div class="row ">
                                        <div class="col-lg-12">
                                            ...
                                            <form method="post" action="edit_Campaign2.php" enctype="multipart/form-data">
                                                <div class="row ">
                                                    <div class="col-lg-5">
                                                        <?php
                                                        $CampID=$_GET['CampID'];
                                                        ...
                                                        <div class="input-group input-group-sm mb-3">
                                                            ...
                                                            <select class="custom-select" id="ctype_id" name="ctype_id" required>
                                                                ...
                                                                <?php //  $orgunit_id = $_SESSION['orgunit_id'];
                                                                $products = [];
                                                         ...
                                                         on tbl_orgunit_ctype.ctype_id = Campaign_type.ctype_id where orgunit_id='$orgunit_id' ";
                                                                ...
                                                                while ($row = $ctype->fetch()) {
                                                                    $selected = "";
                                                                    if ($ctype_idd == $row["ctype_id"]) {
                                                                        $selected = "selected";
                                                                    }
                                                                    echo ' <option value="' . $row["ctype_id"]. '" ' . $selected . ' >' . $row["ctype_name"] . '</option>';
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="input-group  mb-3">
                                                            ...
                                                            <input type="text" id="CampName" name="CampName" class="form-control" value="<?php echo $camp_name; ?>" placeholder="Enter Campaign Name" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
                                                            <input type="text" hidden name="CampID" id="CampID" class="form-control" value="<?php echo $camp_id; ?>" required>
                                                            <input type="text" hidden name="ou_id" id="CampID" class="form-control" value="<?php echo $ou_id; ?>" required>
                                                            <input type="text" hidden name="header_banner_old" id="CampID" class="form-control" value="<?php echo $Header_Banner; ?>" required>
                                                            <input type="text" hidden name="footer_banner_old" id="CampID" class="form-control" value="<?php echo $Footer_Banner; ?>" required>
                                                        </div>
                                                        ...
                                                        <?php if ($_SESSION['data_loading_type'] == "Both") { ?>
                                                            <div class="input-group input-group-sm mb-3">
                                                                ...
                                                                <select class="custom-select" id="CampCat" name="CampCat" required>
                                                                    ...
                                                                    <option value="Manual" <?php if ($Camp_category == "Manual") {
                                                                                                echo "selected";
                                                                                            } ?>> Manual</option>
                                                                    <option value="Automatic" <?php if ($Camp_category == "Automatic") {
                                                                                                    echo "selected";
                                                                                                } ?>> Automatic</option>
...
";
                                                     ...
                                                     //reply_to_emails.rtemid=tbl_orgunit_rte.rtemid AND reply_to_emails.rtemid = :rtemid AND rtem_status='Active' AND status='Active'");
                                                                  ...
                                                                  //  }
                                                                ?>
                                                                    <!-- <option value="<?php //echo $rtem; ?>" <?php //echo $selected; ?>> <?php //echo $rowr['reply_to_email'] ?> </option> -->
                                                                <?php
                                                               // } ?>
                                                               <?php $stmt_getrtemid=$conn->prepare("SELECT reply_to_email FROM reply_to_emails WHERE rtemid='$rtemid'");
                                                               $stmt_getrtemid->execute();
                                                               $rtemail = $stmt_getrtemid->fetch();?>

                                                                <option  value="<?php echo $rtemid; ?>" <?php echo $selected; ?>> <?php echo $rtemail['reply_to_email'] ?> </option> 
                                                        ...
                                                        <div class="input-group input-group-sm mb-3">
                                                            ...
                                                            <select class="custom-select" name="mailservers" id="mailservers" required>
                                                                ...
                                                                <?php foreach ($mailservers as $output) {
                                                                    ...
                                                                    $selected = "";
                                                                    if ($mailserverid == $output["mailserverid"]) {
                                                                        $selected = "selected";
                                                                    }

                                                                    if ($mailserver_campaigns >= $campaigns_allowed && $mailserverid != $output["mailserverid"]) { ?>
                                                                        <option <?php echo $selected; ?> disabled value="<?php echo $output["mailserverid"]; ?>"> <?php echo $MS_name . " (" . $percent . "% busy)"; ?> </option>
                                                                    <?php } else { ?>
                                                                        <option <?php echo $selected; ?> value="<?php echo $output["mailserverid"]; ?>"> <?php echo $MS_name . " (" . $percent . "% busy)"; ?> </option>
                                                                <?php  }
                                                                } ?>
                                                            </select>
                                                        </div>
 ...
 All the required optional input fields are formed using 'Components for campaigns type table' -->
                                                        ...
                                                        <div class="input-group input-group-sm mb-3">
                                                            ...
                                                            <textarea placeholder="Campaign For *" id="CampFor" name="CampFor" class="form-control" required aria-label="With textarea"> <?php echo $CampFor; ?> </textarea>
                                                        </div>
                                                ...
                                                orgunit_id=:orgunit_id");
                                                        $stmts2->bindValue(':orgunit_id', $orgunit_id);
                                                        $stmts2->execute();
                                                        ...
                                                        ?>
                                                                ...
                                                                <div class="input-group input-group-sm mb-3">
                                                                    ...
                                                                    <select class="custom-select" id="embargo_type" onChange=showHide() name="embargo_type">
                                                                        <option <?php if ($embargo_type == "global") {
                                                                                                echo "selected";
                                                                                            } ?> value="global"> Global</option>
                                                                        <option <?php if ($embargo_type == "campaign_embargo") {
                                                                                                echo "selected";
                                                                                            } ?> value="campaign_embargo"> Campaign Wise Embargo</option>
                                                        ...
                                                        <?php if (isset($_SESSION['orgunit_id'])) { ?>
                                                            <button type="submit" name="editCampaign" class="btn btn-primary"><i class="fa fa-plus"></i> Edit Campaign</button>
                                                        <?php } else { ?>
                                                            <button disabled type="submit" name="editCampaign" class="btn btn-primary"><i class="fa fa-plus"></i> Edit Campaign</button>
