    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="container-fluid">
                ...
                $ou_inst_id = $_GET['ou_inst_id'];


                $stmt = $conn->prepare("SELECT institute_name FROM organizational_institutes INNER JOIN registered_institutions ON
                registered_institutions.ri_id= organizational_institutes.ri_id 
                WHERE ou_inst_id='$ou_inst_id' ");
                $stmt->execute();
                $row = $stmt->fetch();

                $stmtd = $conn->prepare("SELECT oui_md, domain FROM org_institute_maildomain
                WHERE ou_inst_id='$ou_inst_id' ");
                $stmtd->execute();
                $rowd = $stmtd->fetchAll();
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h2>Enter Domain for Institute</h2>
                            </div>
                            <div class="body demo-card">
                                <div class="row clearfix">
                                    <div class="col-lg-10 col-md-10">
                                        ...
                                        <form id="advanced-form" action="org_inst_domain_db.php" method="post"  data-parsley-validate novalidate> 
 ...
 $('#multi-select-demo').multiselect({
    ...
    <!-- <script>
        function addoption() {
            ...
            $('#multi-select-demo').append($('<option></option>').attr('value', new_dom).text(new_dom));
