                            ...
                            <div class="body demo-card">
                                <div class="row clearfix">
                                    <div class="col-lg-8 col-md-8">
                                        ...
                                        $stmt = $conn->prepare("SELECT tbl_activity.activity_id, activity_name FROM tbl_activity INNER JOIN tbl_role_prev_activity ON 
                                        tbl_activity.activity_id = tbl_role_prev_activity.activity_id WHERE tbl_role_prev_activity.role_prev_id=$role_id ");
                                        $stmt->execute();
                                        $row = $stmt->fetchAll();
