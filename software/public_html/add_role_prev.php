                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="custom-validation" action="add_role_prev_db.php" method="post">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="number" name="restriction_level" class="form-control" min="0" max="10" required>
