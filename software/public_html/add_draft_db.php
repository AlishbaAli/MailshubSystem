                    ...
                    <div class="row">
                        ...
                        WHERE CampID = :CampID";
                                ...
                                <button class='mr-2 mb-2 btn btn-primary btn-md' type='button'>Please Check Your Draft!</button></a>
                                        ...
                                        $draft_sub = !empty($_POST['Camp_sub']) ? trim($_POST['Camp_sub']) : null;
...
if (stripos($subscription_draft,$url['url'])!==false) {
    ...
    break;
                                        ...
                                        (   
                                            subscription_draft, draft_subject,
                                            CampID, 
                                ...
                                values (
                                            '" . htmlentities(addslashes($subscription_draft)) . "',
                                             '" . htmlentities(addslashes($draft_sub)) . "',
                                            '" . $CampID . "', 
                                            NOW()
                        ...
                        </div>   <meta http-equiv='refresh' content='2;url=index.php'>";
                                            }
                                        } else {
