...
$stmt = $conn->prepare("SELECT * FROM campaign INNER JOIN tbl_orgunit_user
ON  campaign.ou_id= tbl_orgunit_user.ou_id WHERE Camp_Status<>'Completed' AND Camp_Status<>'Archive'");
$stmt->execute();
