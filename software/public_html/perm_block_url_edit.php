    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="container-fluid">
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2>Update Permanently Block Domain</h2>
                        </div>
                ...
                $stmt = $conn->prepare("SELECT * FROM  permanently_blocked_url WHERE permanently_blocked_urlid= $id");
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div  id="not_allowed_alert" style="display:none" class="alert alert-danger alert-dismissible fade show" role="alert">
                                    ...
                                    <form class="custom-validation" action="perm_block_url_edit_db.php" method="post">
