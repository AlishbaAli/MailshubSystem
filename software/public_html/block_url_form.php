                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div  id="burl_alert" style="display:none" class="alert alert-danger alert-dismissible fade show" role="alert">
                                    ...
                                    <form class="custom-validation" action="block_url_db.php" method="post">
