...
left join (Select  tbl_orgunit_user.user_id,tbl_orgunit_user.ou_id as uido,orgunit_name from tbl_orgunit_user inner join tbl_organizational_unit 
on  tbl_orgunit_user.orgunit_id = tbl_organizational_unit.orgunit_id AND ou_status='Active') as user_org
on `campaign`.ou_id= user_org.uido 
...
on user_org.user_id= user_role.uidr 


left join admin on user_org.user_id =`admin`.AdminId
