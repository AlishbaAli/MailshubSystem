...
$stmt = $conn->prepare("SELECT * FROM `orgunit-systemsetting` WHERE org_settingid= $id");
$stmt->bindValue(':org_settingid', $id);
$stmt->execute();
$org_settings = $stmt->fetch();


$orgunit_id= $org_settings["orgunit_id"];
$stmto = $conn->prepare("SELECT * FROM `tbl_organizational_unit` WHERE orgunit_id= $orgunit_id");
                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2>Update <?php echo $name["orgunit_name"]."'s"?> Settings</h2>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <form id="advanced-form" action="editorg_settings_db.php" method="post" data-parsley-validate novalidate>
                                            ...
                                            <option value="sys-defined" <?php if ($org_settings['embargo_duration_type'] == "sys-defined") {
                                                                            echo ' selected="selected"';
                                                                        } ?>> System Defined</option>
                                            <option value="ou-defined" <?php if ($org_settings['embargo_duration_type'] == "ou-defined") {
                                                                                echo ' selected="selected"';
                                            ...
                                            <div class="form-group ">
                                                <label id="org_embargo_durationl">Embargo Duration (Days <=365) *</label>
                                                        <input value="<?php echo  $org_settings["org_embargo_duration"]; ?>" type="text" id="org_embargo_duration" name="org_embargo_duration" class="form-control" data-parsley-max="365" readonly>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <option value="sys-defined" <?php if ($org_settings['embargo_implementation_type'] == "sys-defined") {
                                                                            echo ' selected="selected"';
                                                                        } ?>> System Defined</option>
                                                   <option value="ou-dedicated" <?php if ($org_settings['embargo_implementation_type'] == "ou-dedicated") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Dedicated</option>
                                                            <option value="ou-hybrid" <?php if ($org_settings['embargo_implementation_type'] == "ou-hybrid") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Hybrid</option>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <option value="sys-defined" <?php if ($org_settings['unsubscription_type'] == "sys-defined") {
                                                                            echo ' selected="selected"';
                                                                        } ?>> System Defined</option>
                                                   <option value="ou-dedicated" <?php if ($org_settings['unsubscription_type'] == "ou-dedicated") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Dedicated</option>
                                                            <option value="ou-hybrid" <?php if ($org_settings['unsubscription_type'] == "ou-hybrid") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Hybrid</option>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <option value="sys-defined" <?php if ($org_settings['max_records_type'] == "sys-defined") {
                                                                            echo ' selected="selected"';
                                                                        } ?>> System Defined</option>
                                                   <option value="ou-defined" <?php if ($org_settings['max_records_type'] == "ou-defined") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Defined</option>
                                            ...
                                            <div class="form-group ">
                                                <label id="max_recordsl">Maximum Records To Fetch (Records <=50000)*</label>
                                                        <input value="<?php echo  $org_settings["max_records"]; ?>" type="text" name="max_records" id="max_records" class="form-control" required data-parsley-range="[1,50000]"readonly>
                                            ...
                                            <option value="sys-defined" <?php if ($org_settings['ipblack_allowed_type'] == "sys-defined") {
                                                                            echo ' selected="selected"';
                                                                        } ?>> System Defined</option>
                                                   <option value="ou-defined" <?php if ($org_settings['ipblack_allowed_type'] == "ou-defined") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Defined</option>
                                        ...
                                        <div class="form-group ">
                                            <label id="ipblack_max_allowed_scorel">Max Allowed Score(Score <=9)</label>
                                             <input value="<?php echo  $org_settings["ipblack_max_allowed_score"]; ?>" type="text" id="ipblack_max_allowed_score" name="ipblack_max_allowed_score" class="form-control" required data-parsley-range="[0,9]"readonly>

                                        </div>
                                        <div class="form-group ">
                                            <label id="ipblack_allowed_colorl">Allowed Color</label>

                                            <input value="<?php echo  $org_settings["ipblack_allowed_color"]; ?>" type="text" id="ipblack_allowed_color" name="ipblack_allowed_color" class="form-control" required readonly>
                                    ...
                                    <div class="form-group ">
                                        <label> Customizable Campaign Embargo *</label>
                                            ...
                                            <option value="YES" <?php if ($org_settings['customizable_camp_embargo'] == "YES") {
                                                                                    echo ' selected="selected"';
                                                                                } ?>>YES</option>
                                            <option value="NO" <?php if ($org_settings['customizable_camp_embargo'] == "NO") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>NO</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                                ...
                                                <option value="sys-defined" <?php if ($org_settings['domain_block_type'] == "sys-defined") {
                                                                            echo ' selected="selected"';
                                                                        } ?>> System Defined</option>
                                                   <option value="ou-dedicated" <?php if ($org_settings['domain_block_type'] == "ou-dedicated") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Dedicated</option>
                                                            <option value="ou-hybrid" <?php if ($org_settings['domain_block_type'] == "ou-hybrid") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Hybrid</option>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <option value="sys-defined" <?php if ($org_settings['url_block_type'] == "sys-defined") {
                                                                            echo ' selected="selected"';
                                                                        } ?>> System Defined</option>
                                                   <option value="ou-dedicated" <?php if ($org_settings['url_block_type'] == "ou-dedicated") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Dedicated</option>
                                                            <option value="ou-hybrid" <?php if ($org_settings['url_block_type'] == "ou-hybrid") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Hybrid</option>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <option value="Manual" <?php if ($org_settings['data_loading_type'] == "Manual") {
                                                                            echo ' selected="selected"';
                                                                        } ?>> Manual</option>
                                                   <option value="Automatic" <?php if ($org_settings['data_loading_type'] == "Automatic") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Automatic</option>
                                                            <option value="Both" <?php if ($org_settings['data_loading_type'] == "Both") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Both</option>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <option value="sys-defined" <?php if ($org_settings['api_type'] == "sys-defined") {
                                                                            echo ' selected="selected"';
                                                                        } ?>> System Defined</option>
                                                   <option value="ou-defined" <?php if ($org_settings['api_type'] == "ou-defined") {
                                                                                echo ' selected="selected"';
                                                                            } ?>>Organizational Defined</option>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input value="<?php echo  $org_settings["api_key"]; ?>" type="text" name="api_key" id="api_key" class="form-control" readonly>

                                        </div>
                                        <div class="form-group ">
                                            <label id="urll">URL</label>
                                            <input value="<?php echo  $org_settings["url"]; ?>" type="text" name="url" id="url" class="form-control" readonly>
...
<option value="Active" <?php if ($org_settings['status'] == "Active") {
                            echo ' selected="selected"';
                        } ?>>Active</option>
<option value="In Active" <?php if ($org_settings['status'] == "In Active") {
                                echo ' selected="selected"';
                            } ?>>In Active</option>
                                        ...
                                        <input hidden value="<?php echo  $id?>" type="text" name="id" id="id">
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                <button class="btn btn-primary btn-lg waves-effect waves-light icon-refresh" type="submit" id="submit">
                                                    Update 
                                                </button>
