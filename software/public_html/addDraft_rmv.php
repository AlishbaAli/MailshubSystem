                        ...
                        <div class="card">
                            ...
                            <h5 class="form-header">
                                ...
                                if (isset($_GET['CampID'])) {
                                    ...
                                    $sql = "SELECT COUNT(CampName) AS num , CampName, CampID, ou_id
                                    FROM campaign 
                                    WHERE CampID = :CampID";
                    ...
                    <div class="card">
                        <div class="body">                          
                            ...
                            <button type="button" class="btn btn-danger" data-dismiss="modal">CLOSE</button>
                                 ...
                                 <br> <br>
                                <form action="add_draft_db.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group  mb-3">
                               ...
                               <input type="text" id="Camp_sub" name="Camp_sub" class="form-control" placeholder="Enter Campaign Subject" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
                                    ...
                                    <? }
                                     ...
                                     <button disabled type="submit" id="submit" name="submitDraft" class="btn btn-primary">Submit</button>
