                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-12">
                            <h2>Add Organizational URL Block</h2>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div  id="burlo_alert" style="display:none" class="alert alert-danger alert-dismissible fade show" role="alert">
                                                    <i class="mdi mdi-check-all mr-2"></i> URL  already exists!
                                    ...
                                    <form class="custom-validation" action="block_urlorg_db.php" method="post">
