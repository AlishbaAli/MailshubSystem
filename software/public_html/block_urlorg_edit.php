    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="container-fluid">
                ...
                $blocked_url_orgid = $_GET["id"];

                $sql = "SELECT *
FROM
`blocked_url_org` WHERE blocked_url_orgid=:blocked_url_orgid";

                $stmt = $conn->prepare($sql);
                $stmt->bindValue(':blocked_url_orgid', $blocked_url_orgid);
                $result = $stmt->execute();
                $row = $stmt->fetch();
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="demo-masked-input">
                                    <form class="custom-validation" action="block_urlorg_edit_db.php" method="post">

                                        <div class="form-group ">
                                            <label> URL *</label>
                                            <input type="text" name="url" value="<?php echo $row["url"] ?>" class="form-control" readonly required>
                                        ...
                                        <input hidden type="text" name="blocked_url_orgid" class="form-control" value="<?php echo $blocked_url_orgid;?>" >
